...
class LoggingSink(AuditSink):
    ...
    def __init__(
        self,
        logger_name: str = "langextract.audit",
...
class OtelSpanSink(AuditSink):
    ...
    packages (install via ``pip install langextract-audit[otel]``).
    ...
    def __init__(self, tracer_name: str = "langextract.audit") -> None:
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install langextract-audit[otel]"
            ) from exc
